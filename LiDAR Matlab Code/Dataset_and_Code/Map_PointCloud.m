...
cropPtCloud = Sokil_LiDAR.cropPointCloud(fixElevationPtCloud,-20,20,-20,20,0,1);
noGroundPtCloud = Sokil_LiDAR.removePointCloudGround(cropPtCloud);
Sokil_LiDAR.plotPointCloud(noGroundPtCloud, "cropped fix orientation ptcloud")
pcviewer(cropPtCloud)
